...
function _applySection(sec){
  ...
  if(window._returnToCarId && ['asigurari','itp','mentenanta'].includes(sec)){
    setTimeout(()=>{
  ...
  } else if(!['asigurari','itp','mentenanta'].includes(sec)) {
...
function rGaraj(){
  ...
  el.innerHTML=cars.map(c=>{
    ...
    return`<div class="cc" style="transition:transform 0.15s,box-shadow 0.15s" onmouseover="this.style.transform='translateY(-2px)';this.style.boxShadow='0 8px 24px rgba(0,0,0,0.3)'" onmouseout="this.style.transform='';this.style.boxShadow=''">
  ...
  body.innerHTML = `
    ...
    <div style="background:linear-gradient(135deg,rgba(200,150,12,0.12),rgba(79,125,255,0.06));border:1px solid rgba(200,150,12,0.2);border-radius:16px;padding:20px;margin-bottom:20px">
      ...
      <div style="display:flex;gap:8px;margin-top:16px;flex-wrap:wrap">
        ...
        <button class="btn btn-ghost btn-sm" onclick="openVanz(${car.id})">💰 Vând mașina</button>
    ...
    <div class="card" style="margin-bottom:16px">
      <div class="ch"><span class="ct">⛽ Jurnal Combustibil</span><button class="btn btn-ghost btn-sm" onclick="goTo('mentenanta');setTimeout(()=>mntTab('combustibil'),200)" style="font-size:11px">Vezi tot →</button></div>
