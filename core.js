...
function buildAgentPrompt(agent) {
  ...
  const general = '\n\nPOȚI RĂSPUNDE LA ORICE ÎNTREBARE — nu doar auto. Ești un AI complet. Dacă primești context din internet sau vreme în mesaj (marcat cu [Context din internet] sau [Vreme actuală]), folosește-l direct în răspuns. Nu spune niciodată că nu poți verifica ceva — dacă ai contextul, folosește-l; dacă nu ai, estimează sau explică ce știi. Răspunzi în română, natural, fără markdown excesiv.';
  ...
  const base = {
    ...
    documente: `Ești Agentul Documente — specialist RCA, ITP, rovinietă, asigurări. Știi exact ce documente are utilizatorul, când expiră și ce trebuie făcut. Ajuți cu proceduri, amenzi, termene.`,
    juridic:   `Ești Agentul Juridic — expert legislație auto română 2026, contracte vânzare, drepturi consumatori, amenzi, contestații, GDPR auto. Răspunzi clar și util, menționezi când e nevoie de avocat real.`,
  ...
  return (base[agent] || base.manager) + carCtx + platformCtx + general;
}
