...
function vanzLightbox(startIdx){
  ...
  if(!document.getElementById('vanz-lb')){
    document.body.insertAdjacentHTML('beforeend', `
      <div id="vanz-lb" style="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:9999;display:flex;align-items:center;justify-content:center;flex-direction:column;gap:12px" onclick="if(event.target===this)document.getElementById('vanz-lb').remove()">
        <button onclick="document.getElementById('vanz-lb').remove()" style="position:absolute;top:16px;right:16px;background:rgba(255,255,255,0.1);border:none;color:#fff;width:36px;height:36px;border-radius:50%;cursor:pointer;font-size:20px">×</button>
        <div style="position:relative;display:flex;align-items:center;gap:12px;max-width:90vw">
          <button id="vanz-lb-prev" onclick="vanzLbNav(-1)" style="background:rgba(255,255,255,0.1);border:none;color:#fff;width:44px;height:44px;border-radius:50%;cursor:pointer;font-size:22px;flex-shrink:0">‹</button>
          <img id="vanz-lb-img" style="max-width:75vw;max-height:75vh;border-radius:12px;object-fit:contain">
          <button id="vanz-lb-next" onclick="vanzLbNav(1)" style="background:rgba(255,255,255,0.1);border:none;color:#fff;width:44px;height:44px;border-radius:50%;cursor:pointer;font-size:22px;flex-shrink:0">›</button>
        </div>
        <div id="vanz-lb-count" style="color:rgba(255,255,255,0.5);font-size:13px"></div>
      </div>`);
    // Keyboard navigation
