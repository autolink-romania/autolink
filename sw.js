// Guard: sw.js rulează atât ca script de pagină cât și ca Service Worker
// Când rulează ca SW, skipăm tot codul de pagină
if(typeof window === 'undefined') {
  // Service Worker minimal - doar cache
  const CACHE_NAME = 'autoassist-v3';
  const STATIC = ['/app.html','/style.css','/core.js','/asistent.js','/ev-vocal-init.js','/rca-itp.js','/vanzare-cv.js','/documente.js','/mentenanta.js','/vehicul.js'];
